...
class Model:
    ...
    def step(self) -> None:
        """Advance one step, raising ValueError on component failure.

        A failed step may leave partially updated state. Restore a checkpoint
        before retrying.
        """
        ...
    def run(self) -> None:
        """Run to completion, raising ValueError on component failure.
