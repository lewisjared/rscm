...
Defines the variable schema system for declaring model variables and aggregates independently of components.
The schema provides a centralised definition of all variables in a model, their units, grid types, and aggregation relationships.
