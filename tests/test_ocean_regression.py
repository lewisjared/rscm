...
def load_ocean_regression_data(name: str) -> tuple[pd.DataFrame, dict]:
    """
    Load ocean regression test data and config.

    The CSV is in scmdata wide format: metadata columns followed by
    timestamp columns (e.g., "1850-01-01 00:00:00"). This function
    loads it and converts to a long-format DataFrame with columns
    (year, variable, unit, region, value) matching the format used
    by the existing regression tests.

    Parameters
    ----------
    name
        Test name (e.g., "ocean_02_constant_upwelling")
    ...
    """
    csv_path = REGRESSION_DATA_DIR / f"{name}.csv"
    ...
    # Timestamp columns are everything after the metadata columns
    ...
    # Extract year from timestamp strings like "1850-01-01 00:00:00"
...
def get_variable_values(
    ...
    ----------
    df
        Long-format DataFrame from load_ocean_regression_data
    variable
...
def run_ocean_scenario(
    ...
    ----------
    name
        Scenario name (e.g., "ocean_02_constant_upwelling")
    rtol
    ...
    """
    df, config = load_ocean_regression_data(name)
...
def test_ocean_01_diffusion_only():
    ...
    """
    run_ocean_scenario("ocean_01_diffusion_only", rtol=0.15)
...
def test_ocean_02_constant_upwelling():
    ...
    with temperature.
    """
    run_ocean_scenario("ocean_02_constant_upwelling", rtol=0.15)
...
def test_ocean_03_depth_dependent_area():
    ...
    """
    run_ocean_scenario("ocean_03_depth_dependent_area", rtol=0.15)
...
def test_ocean_04_variable_upwelling():
    ...
    """
    run_ocean_scenario("ocean_04_variable_upwelling", rtol=0.15)
...
def test_ocean_05_temp_dependent_diffusivity():
    ...
    """
    run_ocean_scenario("ocean_05_temp_dependent_diffusivity", rtol=0.15)
...
def test_ocean_06_ground_heat():
    ...
    """
    run_ocean_scenario("ocean_06_ground_heat", rtol=0.15)
...
def test_ocean_07_interhemispheric_exchange():
    ...
    """
    run_ocean_scenario("ocean_07_interhemispheric_exchange", rtol=0.15)
...
def test_ocean_08_sst_to_sat():
    ...
    """
    df, config = load_ocean_regression_data("ocean_08_sst_to_sat")
    years, expected_temp = get_variable_values(df, "Surface Temperature")
...
def test_ocean_09_time_varying_ecs():
    ...
    forcing level.
    """
    run_ocean_scenario("ocean_09_time_varying_ecs", rtol=0.15)
...
def test_ocean_10_full_default():
    ...
    """
    df, config = load_ocean_regression_data("ocean_10_full_default")
    years, expected_temp = get_variable_values(df, "Surface Temperature")
