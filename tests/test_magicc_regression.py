...
@pytest.mark.xfail(
    reason=(
        "ClimateUDEB simplified implementation diverges from MAGICC7"
        " (~20% warm bias). Missing: LAMCALC iterations,"
        " temperature-dependent diffusivity,"
        " depth-dependent ocean area, internal variability modes."
    )
)
